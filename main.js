...
<p>Mijn naam is Floris Puts en ben 20 jaar.Nadat ik de mbo opleiding elektrotechniek heb afgerond ben gestart op Sint Lucas in Eindhoven.Ik volg daar de opleiding software development. Ik woon in Koningsbosch samen met mijn ouders en broertje. Ik zit op scouting als leider van de scouts en progammeer soms in mijn vrije tijd. <b>Klik hier naast op een van de mapjes om projecten te openen!</b></p>
</div>`,
`<div class="arcade animation" id="arcade">
<h2>Arcadegame</h2>
<img src="pic/arcade1.png" alt="">
<p>In het 2de jaar van mijn studie heb ik met een groepje studenten (2 software developers en 3 gameartists) een arcade game  gemaakt. Ik vond dit een leuke opdracht omdat het verzinnen en maken van deze game en het samenwerken leuk vond. Dit hebben we gemaakt in Unity met C#.</p>
